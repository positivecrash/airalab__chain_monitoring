...
gulp.task('live', function() {
	...
	//watch .scss files
	gulp.watch(['app/styles/utilities/*.scss', 'app/styles/sections/*.scss', 'app/styles/pages/*.scss', 'app/styles/plugins/*.scss', 'app/styles/templates/*.scss', 'app/styles/airalabrus.scss'], ['styles']);
...
//default
gulp.task('default', ['scripts', 'styles', 'templates', 'sprite', 'live']);
